...
The CDN build exposes a global `TRCalendar` object. See the [CDN Usage](/vanilla/cdn/) guide for full details.
...
For more advanced CDN features like reading events, check the [CDN Usage](/vanilla/cdn/) guide.
...
Each theme has a dark variant (e.g., `ocean-dark`). See [Themes](/core/themes/) for the full list.
...
- [CDN Usage](/vanilla/cdn/) -- use via script tag, no build step
- [Examples](/vanilla/examples/) -- comprehensive code samples for every feature
- [Themes](/core/themes/) -- all themes and CSS customization
- [Date Conversion](/core/date-conversion/) -- AD/BS conversion utilities
