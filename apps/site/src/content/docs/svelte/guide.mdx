...
|---|---|
| [`createCalendar`](/svelte/calendar/) | Single calendar with month/year pickers |
| [`createSelection`](/svelte/range-selection/) | Unified selection: single, range, or multiple |
| [`createDatePicker`](/svelte/date-picker/) | Calendar inside a popup with input field |
| [`createMultiCalendar`](/svelte/multi-calendar/) | Multiple months displayed side by side |
...
- [Calendar (createCalendar)](/svelte/calendar/) -- BS/AD, month picker, year picker, Nepali locale
- [Range Selection (createSelection)](/svelte/range-selection/) -- date range and multi-date selection
- [Multi-Calendar (createMultiCalendar)](/svelte/multi-calendar/) -- side-by-side months
- [Date Picker (createDatePicker)](/svelte/date-picker/) -- input + dropdown calendar
- [All Examples](/svelte/examples/) -- interactive demo of every feature
