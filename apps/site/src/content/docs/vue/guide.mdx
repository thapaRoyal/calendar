...
| Composable | Purpose |
|---|---|
| [`useCalendar`](/vue/calendar/) | Single calendar with month/year pickers |
| [`useSelection`](/vue/range-selection/) | Unified selection: single, range, or multiple |
| [`useDatePicker`](/vue/date-picker/) | Calendar inside a popup with input field |
| [`useMultiCalendar`](/vue/multi-calendar/) | Multiple months displayed side by side |
...
- [Calendar (useCalendar)](/vue/calendar/) -- BS/AD, month picker, year picker, Nepali locale
- [Range Selection (useSelection)](/vue/range-selection/) -- date range and multi-date selection
- [Multi-Calendar (useMultiCalendar)](/vue/multi-calendar/) -- side-by-side months
- [Date Picker (useDatePicker)](/vue/date-picker/) -- input + dropdown calendar
- [All Examples](/vue/examples/) -- interactive demo of every feature
